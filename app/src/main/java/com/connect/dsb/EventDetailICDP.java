...
public class EventDetailICDP extends Fragment {

    public EventDetailICDP() {
    }

    @Override
    public void onViewCreated(View view,Bundle savedInstanceState){
        super.onViewCreated(view, savedInstanceState);
        getActivity().setTitle("Event Detail Icdp");
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.event_detail_icdp, container, false);


//        JustifiedTextView myMsg = (JustifiedTextView)rootView.findViewById(R.id.icdp_event_detail_1);
...
//
//
//        Button a1 = (Button) rootView.findViewById(R.id.icdp_button);
